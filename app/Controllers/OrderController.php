...
final class OrderController extends Controller
{
    ...
    public function listByUser(): void
    {
        ...
        $this->render('home/order-list', params: [
            'title' => 'Mes commandes',
            'orders' => $orders,
            'user_id' => $user_id
        ]);
    ...
    public function listValidated(): void
    {
        ...
        $this->render('home/order-validated', params: [
    ...
    public function show(): void
    {
        ...
        if (!$order) {
            $this->render('home/order-not-found', params: [
                'title' => 'Commande introuvable'
            ]);
            return;
        }
        
        $this->render('home/order-show', params: [
    ...
    public function create(): void
    {
        if ($_SERVER['REQUEST_METHOD'] !== 'POST') {
            header('Location: /mini_mvc/public/cart?user_id=' . ($_GET['user_id'] ?? 1));
            return;
        }
        ...
        if (empty($cartItems)) {
            header('Location: /mini_mvc/public/cart?user_id=' . $user_id . '&error=empty_cart');
            return;
        }
        ...
        if ($orderId) {
            header('Location: /mini_mvc/public/cart?user_id=' . $user_id . '&success=order_created');
        } else {
            header('Location: /mini_mvc/public/cart?user_id=' . $user_id . '&error=create_failed');
        }
    }
